...
class Bot(discord.Client):
    ...
    def __init__(self, answer_scores):
        ...
        # embed creation
        self.embed=discord.Embed(title="TRIVIA ANSWER", description="**Google Searching** ••••:spy:")
        self.embed.set_thumbnail(url='https://cdn.discordapp.com/attachments/643768258083684373/644048700032811038/JPEG_20191112_195646.jpg')
        ...
        self.embed.set_footer(text=f"MAHAKAL & HACKER & HIT", \
            icon_url="https://cdn.discordapp.com/attachments/643768258083684373/644048700032811038/JPEG_20191112_195646.jpg")
...
#                 three_check = ":x:"            
    ...
    async def on_ready(self):
        ...
        await self.change_presence(activity=discord.Game(name='MAHAKAL & HACKER & HIT|| @help'))
    ...
    async def on_message(self, message):
        ...
        if message.content.startswith('?help'):
          if BOT_OWNER_ROLE in [role.name for role in message.author.roles]:
           ...
           embed.add_field(name="Support Game", value="**Loco\Flipkard\Hq trivia\jeetoh**", inline=False)
...
def bot_with_cyclic_update_process(update_event, answer_scores):
    ...
    loop.create_task(bot.start('NjQ0OTMyOTU5NDUwNjkzNjMy.Xc7Org.uzOhyPw1HfJEazwdaRgspnrDhA8'))
    loop.run_forever()
